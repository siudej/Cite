# -*- coding: utf-8 -*-
""" pyqtConfig by Martin Fitzpatrick. """
# from __future__ import unicode_literals
import logging

# pylama:ignore=W,D,E501,E303,E265,E272,E731

import types

try:
    from PyQt5.QtCore import Qt, QObject, pyqtSignal, QMutex, QMutexLocker, \
        QSettings, QVariant
except:
    from PyQt4.QtCore import Qt, QObject, pyqtSignal, QMutex, QMutexLocker, \
        QSettings, QVariant
